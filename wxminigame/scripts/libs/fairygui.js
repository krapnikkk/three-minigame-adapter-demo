(function (global, factory) {
    ...
    */
        ...
        switch (origin) {
            case exports.FillOrigin.Top:
                if (amount <= 0.5) {
                    ...
                    if (!clockwise)
                        vertRect.x += vertRect.width;
                    fillRadial90(vb, vertRect, clockwise ? exports.FillOrigin.TopRight : exports.FillOrigin.TopLeft, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.x += vertRect.width;
                    else
                        vertRect.x -= vertRect.width;
            ...
            case exports.FillOrigin.Bottom:
                if (amount <= 0.5) {
                    ...
                    if (clockwise)
                        vertRect.x += vertRect.width;
                    fillRadial90(vb, vertRect, clockwise ? exports.FillOrigin.BottomLeft : exports.FillOrigin.BottomRight, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.x -= vertRect.width;
                    else
                        vertRect.x += vertRect.width;
            ...
            case exports.FillOrigin.Left:
                if (amount <= 0.5) {
                    ...
                    if (clockwise)
                        vertRect.y += vertRect.height;
                    fillRadial90(vb, vertRect, clockwise ? exports.FillOrigin.TopLeft : exports.FillOrigin.BottomLeft, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.y -= vertRect.height;
                    else
                        vertRect.y += vertRect.height;
            ...
            case exports.FillOrigin.Right:
                if (amount <= 0.5) {
                    ...
                    if (!clockwise)
                        vertRect.y += vertRect.height;
                    fillRadial90(vb, vertRect, clockwise ? exports.FillOrigin.BottomRight : exports.FillOrigin.TopRight, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.y += vertRect.height;
                    else
                        vertRect.y -= vertRect.height;
        ...
        switch (origin) {
            case exports.FillOrigin.Top:
                if (amount < 0.5) {
                    ...
                    if (!clockwise)
                        vertRect.x += vertRect.width;
                    fillRadial180(vb, vertRect, clockwise ? exports.FillOrigin.Right : exports.FillOrigin.Left, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.x += vertRect.width;
                    else
                        vertRect.x -= vertRect.width;
            ...
            case exports.FillOrigin.Bottom:
                if (amount < 0.5) {
                    ...
                    if (clockwise)
                        vertRect.x += vertRect.width;
                    fillRadial180(vb, vertRect, clockwise ? exports.FillOrigin.Left : exports.FillOrigin.Right, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.x -= vertRect.width;
                    else
                        vertRect.x += vertRect.width;
            ...
            case exports.FillOrigin.Left:
                if (amount < 0.5) {
                    ...
                    if (clockwise)
                        vertRect.y += vertRect.height;
                    fillRadial180(vb, vertRect, clockwise ? exports.FillOrigin.Top : exports.FillOrigin.Bottom, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.y -= vertRect.height;
                    else
                        vertRect.y += vertRect.height;
            ...
            case exports.FillOrigin.Right:
                if (amount < 0.5) {
                    ...
                    if (!clockwise)
                        vertRect.y += vertRect.height;
                    fillRadial180(vb, vertRect, clockwise ? exports.FillOrigin.Bottom : exports.FillOrigin.Top, (amount - 0.5) / 0.5, clockwise);
                    if (clockwise)
                        vertRect.y += vertRect.height;
                    else
                        vertRect.y -= vertRect.height;
    ...
    class Image extends DisplayObject {
        ...
        get fillMethod() {
            return this._fillMesh ? this._fillMesh.method : exports.FillMethod.None;
        }
        set fillMethod(value) {
            if (!this._fillMesh) {
                if (value == exports.FillMethod.None)
                    return;
        ...
        onPopulateMesh(vb) {
            if (this._fillMesh && this._fillMesh.method != exports.FillMethod.None) {
        ...
        sliceFill(vb) {
            ...
            if (flip != exports.FlipType.None) {
                if (flip == exports.FlipType.Horizontal || flip == exports.FlipType.Both) {
                    gridRect.x = sourceW - gridRect.xMax;
                    gridRect.xMax = gridRect.x + gridRect.width;
                }
                if (flip == exports.FlipType.Vertical || flip == exports.FlipType.Both) {
    ...
    })(exports.ScreenMatchMode || (exports.ScreenMatchMode = {}));
    class UIContentScaler {
        ...
        static scaleWithScreenSize(designResolutionX, designResolutionY, screenMatchMode) {
            ...
            _scaleMode = exports.ScaleMode.ScaleWithScreenSize;
            _screenMatchMode = screenMatchMode || exports.ScreenMatchMode.MatchWidthOrHeight;
            refresh();
        }
        static setConstant(constantScaleFactor) {
            _scaleMode = exports.ScaleMode.ConstantPixelSize;
            _constantScaleFactor = constantScaleFactor || 1;
            refresh();
        }
    }
    var _scaleMode = exports.ScaleMode.ConstantPixelSize;
    ...
    function refresh() {
        ...
        if (_scaleMode == exports.ScaleMode.ScaleWithScreenSize) {
            ...
            if (_screenMatchMode == exports.ScreenMatchMode.MatchWidthOrHeight) {
                let s1 = screenWidth / dx;
                let s2 = screenHeight / dy;
                _scaleFactor = Math.min(s1, s2);
            }
            else if (_screenMatchMode == exports.ScreenMatchMode.MatchWidth)
                _scaleFactor = screenWidth / dx;
            else
                _scaleFactor = screenHeight / dy;
        }
        else if (_scaleMode == exports.ScaleMode.ConstantPhysicalSize) ;
        else
        ...
        static loadPackage(resKey, onProgress) {
            return new Promise(resolve => {
                ...
                loader.load(url, asset => {
                    ...
                    for (var i = 0; i < cnt; i++) {
                        var pi = pkg._items[i];
                        if (pi.type == exports.PackageItemType.Atlas) {
                            promises.push(loadTexture(pi, onProgress));
                        }
                        else if (pi.type == exports.PackageItemType.Sound) {
    ...
    class TextField extends DisplayObject {
        ...
        onSizeChanged() {
            if (!this._updatingSize) {
                if (this._autoSize == exports.AutoSizeType.Shrink || this._wordWrap)
                    this._textChanged = true;
                else if (this._autoSize != exports.AutoSizeType.None)
                    this._graphics.setMeshDirty();
        ...
        ensureSizeCorrect() {
            if (this._textChanged && this._autoSize != exports.AutoSizeType.None)
                this.buildLines();
        }
        ...
        buildLines() {
            ...
            if (this._text.length == 0) {
                ...
                this.parseText();
                this.buildLines2();
                if (this._autoSize == exports.AutoSizeType.Shrink)
                    this.doShrink();
            }
        ...
        onPopulateMesh(vb) {
            ...
            let posx = 0;
            let indent_x;
            let clipping = !this.isInput && this._autoSize == exports.AutoSizeType.None;
            let lineClipped;
            let lineAlign;
            let vertCount;
            let underlineStart;
    ...
    class GTextField extends GObject {
        constructor() {
            ...
            this._text = "";
            this._textField.autoSize = exports.AutoSizeType.Both;
        ...
        set autoSize(value) {
            ...
            if (value == exports.AutoSizeType.Both) {
                this._textField.wordWrap = false;
                if (!this._underConstruct)
                ...
                if (value == exports.AutoSizeType.Height) {
                    if (!this._underConstruct) {
        ...
        updateSize() {
            if (this._updatingSize)
                return;
            this._updatingSize = true;
            if (this._textField.autoSize == exports.AutoSizeType.Both) {
                this.setSize(this._textField.width, this._textField.height);
            }
            else if (this._textField.autoSize == exports.AutoSizeType.Height) {
        ...
        handleSizeChanged() {
            ...
            if (this._underConstruct)
                this._textField.setSize(this.width, this.height);
            else if (this._textField.autoSize != exports.AutoSizeType.Both) {
                if (this._textField.autoSize == exports.AutoSizeType.Height) {
